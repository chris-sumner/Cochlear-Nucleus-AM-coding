function DPvsVSegs_paperfig_v3(statsmat_oneperunit,dpmax,measure)
...
% These are some example pure tone PSTHs. 
...
subplot(dph_ChS); axis([0 800 -0.1 dpmax]); box off; ylabel(measure,'fontweight','bold');
text(-100,dpmax*8/7,'b. Examples of classifier performance','fontweight','bold','fontsize',12);
set(dph_ChS,'xtick',[0:200:800],'fontsize',10); title(''); %,'ytick',[1:7]

subplot(vsh_ChS); axis([0 800 -0.02 1]); box off; ylabel('VS','fontweight','bold');
text(-100,1.2,'c. Phase-locking in the same examples','fontweight','bold','fontsize',12);
...
subplot(dph_ChT); 
axis([0 800 -0.1 dpmax]); box off;
set(dph_ChT,'xtick',[0:200:800],'fontsize',10); title(''); %,'ytick',[1:7]
...
subplot(dph_PL); 
axis([0 1800 -0.1 dpmax]); box off; 
set(dph_PL,'xtick',[0:400:2000],'fontsize',10); title(''); % ,'ytick',[1:7]
subplot(vsh_PL); 
...
subplot(dph_PLN); 
axis([0 1800 -0.1 dpmax]); box off; 
set(dph_PLN,'xtick',[0:400:2000],'fontsize',10); title(''); %,'ytick',[1:7]
subplot(vsh_PLN); 
axis([0 1800 -0.02 1]); box off;
