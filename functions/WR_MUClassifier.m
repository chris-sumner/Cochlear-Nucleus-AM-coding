...
% Compute a bunch more statistics. 
unitoutput = WR_ConfusionMatrixStats( unitoutput );
...
[softmax_Z softmax_B softmax_err softmax_fit] = fitSoftMax2ConfMat(unitoutput.confusionmatrix,wsmooth,wnoise,niter,plims,Zmax);
unitoutput.softmax_Z = softmax_Z;
unitoutput.softmax_B = softmax_B;
% Store the fit, but remove the predicted confusion matrices,
% which are easy to regenerate. 
unitoutput.softmax_fit = rmfield(softmax_fit  ,{'pmodel_init','pmodel_final'} );
