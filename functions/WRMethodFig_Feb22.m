...
% a3 = subplot(3,1,3); axis off;
% WREgFig(thesespikes(amfreq_inds),125,125,allModFreqs(amfreq_inds),1,a3);
...
a4 = subplot('position',[0.5 0.2 0.3 0.55]); axis off;
...
text(n_dists*-0.05, n_dists,'comparison spike train','fontweight','bold', ...
...
annotation('arrow',[0.718 0.718],[0.83 0.75])
...
text(n_dists*0.5, n_dists*-0.3,'pick 1 spike train','fontweight','bold', ...
    'fontsize',fontsize2);
text(n_dists*0.53, n_dists*-0.2,'for f_m_o_d= \omega Hz','fontweight','bold', ...
    'fontsize',fontsize2);
